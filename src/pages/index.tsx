  ...
  return <>
      ...
      <HomePageSection title="Welcome">
        <p>
          ...
          organization enters its second century, we want to support and
          foster that endeavor.
        </p>
        <h3>Mission</h3>
        <p>
          The Daily Bruin Alumni Network will actively engage the alumni of
          the Daily Bruin to serve as a robust community for all former staff
          members, in support of each other and The Bruin. The DBAN will
          provide funding, mentorship and professional development programs
          for aspiring student-journalists at UCLA, ensuring the excellence
          and longevity of The Bruin. The DBAN will encourage students to
          reach beyond UCLA, supporting community programs to advance news
          literacy and the free press.
        </p>
      ...
      <HomePageSection title="Alumni Spotlight">
        <FeatureQuote speaker="Gary E. Knell ’75" speakerClassInfo="Viewpoint Editor 1975" speakerCurrentInfo="Chief Executive Officer, National Geographic Partners" image={data.gary.childImageSharp.fluid} quote="The Daily Bruin was the core of my education at UCLA.  It taught me how to write, how to take criticism, how to organize teams, and provided an avenue to question authority constructively.  It’s important to nurture and save in this ‘post truth’ era. There’s never been a more important time to promote these attributes." />
      </HomePageSection>

      <HomePageSection title="What are alumni up to?">
        <a className="twitter-timeline" data-height="600" href="https://twitter.com/tannerbwalters/lists/ucla-daily-bruin-alumni?ref_src=twsrc%5Etfw">
          A Twitter List by tannerbwalters
        </a>
      </HomePageSection>
      <Footer githubName="alumni" developers={['Nathan Smith']} copyrightYear={2018} />
    </>;
};
