    ...
    <PageContainer title="Events" featureImage={image}>
      ...
      >
        <div>
          ...
          <p>
            The Daily Bruin Alumni Network is excited to host its
          ...
          <hr/>
          <p>
            Join us Friday afternoon for breakout sessions with past and present Daily Bruin
            staffers, along with tours of campus and the newsroom. A full daytime schedule to come.
          </p>
          <p>
            That evening, we will gather in the James West Alumni Center for a reception and
            dinner program, which will feature the Daily Bruin Alumni Network's first Distinguished
            Alumni honoree and updates from the organizational leadership and fundraising committees.
          </p>
          <p>
            Join one of our meet-ups on Saturday, either to tailgate the UCLA football
