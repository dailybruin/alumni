      ...
      <PageContent title="About" featureImage={featureImage}>
        ...
        <ul>
          <li>
            ...
            student alumni relations director and current student editor in
            chief to oversee, manage and promote the DBAN.
          </li>
          <li>
            ...
            professions, to strengthen bonds among each other and with the
            current students.
          </li>
          <li>
            A dedicated DBAN website, as well as active social media engagement,
            including private Facebook and LinkedIn groups, for our alumni in
            all professions to network, to reconnect, to promote our events and
            to share general updates and career opportunities.
          </li>
        </ul>
        <h3>Mentorship and Development</h3>
        <ul>
          <li>
            Pro bono advisory workshops and newspaper critiques offered by
            alumni practicing journalists and media professionals for current
            Daily Bruin students and staff.
          </li>
          <li>
          ...
          <li>
            Work with academic departments like Communications Studies and
            English to bolster professional advising and develop journalism
            courses for student-journalists.
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            support, Daily Bruin advisors and staffers will regularly give back
            to the community by going to local middle schools and high schools
            to give workshops on the freedom of the press, journalism's role in
        ...
        <p>
          ...
          publication, The Bruin has had to seek funding from student fees in
          2009 and 2016. To limit rent costs, the Kerckhoff Hall office was
          reduced to about half its previous size in 2017. The full-time student
          media advisor position was eliminated, and the rest of the
          professional staff has been reduced to just three positions. Editor
          stipends have fallen sharply, requiring many staff members to take
          additional jobs.
        </p>
        <p>
          ...
          journalists and media professionals. Here are the ways the DBAN and
          its members can financially support the Daily Bruin:
        </p>
        <ul>
          <li>
          ...
          <li>
            The Daily Bruin Alumni Scholarship & Endowment: Pitch and attract
            both high-dollar donations and regular alumni support, to establish
            an endowment to fund an alumni scholarship for student-journalists
        ...
        <ul>
          <li>
            Spring & Summer 2018 - Recruit and assemble a founding alumni
            working group to set up the organizational structure and develop
            programs and benchmarks for the first 2-4 years. With the current
            Daily Bruin staff, this group would help plan and host the first
            general meeting and alumni reunion.
          </li>
          <li>
            Fall 2018 - The first annual general meeting and reunion of the
            Daily Bruin Alumni Network on Friday, October 5, 2018, in Westwood.
          </li>
          <li>
